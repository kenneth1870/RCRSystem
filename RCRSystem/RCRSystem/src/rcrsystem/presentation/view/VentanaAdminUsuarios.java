...
public class VentanaAdminUsuarios extends javax.swing.JFrame implements java.util.Observer {
      Admin_Usuario_Controlador controller;
    Usuario_Modelo model;
  static VentanaUsuario vistaEdicion;
...
this.setResizable(false);
        ...
        vistaEdicion=new VentanaUsuario(this,true);
    }

    public Admin_Usuario_Controlador getController() {
        return controller;
    }

    public void setController(Admin_Usuario_Controlador controller) {
        this.controller = controller;
    }

    public Usuario_Modelo getModel() {
        return model;
    }

    public void setModel(Usuario_Modelo model) {
        this.model = model;
...
//controller.buscar();    // TODO add your handling code here:
    ...
    private void jButton_agregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_agregarActionPerformed
        Ag_Ed_Usuario_Controlador controladorEdicion = new Ag_Ed_Usuario_Controlador(this.vistaEdicion, model,this.controller);
this.jButton_agregar.setEnabled(false);
        controller.pre_agregar();  
          vistaEdicion.setTitle("Agregar Usuario");
   ...
   Ag_Ed_Usuario_Controlador controladorEdicion = new Ag_Ed_Usuario_Controlador(this.vistaEdicion, model,this.controller);
    ...
    @Override
        ...
        this.jTable_usuarios.setModel(model.obtener_modelo_usuario());
        this.revalidate();
}
