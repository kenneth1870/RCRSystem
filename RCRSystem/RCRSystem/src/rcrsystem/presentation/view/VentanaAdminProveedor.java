...
public class VentanaAdminProveedor extends javax.swing.JFrame implements java.util.Observer {

    Admin_Proveedores_Controlador controller;
    Proveedor_Modelo model;
    static VentanaProveedor vistaEdicion;

    public VentanaAdminProveedor() {
        initComponents();
        setIconImage(new ImageIcon(getClass().getResource("/rcrsystem/presentation/view/iconos/logoRCR.png")).getImage());
        this.setResizable(false);
        setLocationRelativeTo(null);
        vistaEdicion = new VentanaProveedor(this, true);
    }

    public Admin_Proveedores_Controlador getController() {
        return controller;
    }

    public void setController(Admin_Proveedores_Controlador controller) {
        this.controller = controller;
    }

    public Proveedor_Modelo getModel() {
        return model;
    }

    public void setModel(Proveedor_Modelo model) {
        this.model = model;
...
//controller.buscar();    // TODO add your handling code here:
    ...
    private void jButton_agregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_agregarActionPerformed
        Ag_Ed_Proveedor_Controlador controladorEdicion = new Ag_Ed_Proveedor_Controlador(this.vistaEdicion, model, this.controller);
        this.jButton_agregar.setEnabled(false);
        controller.pre_agregar();
        vistaEdicion.setTitle("Agregar Proveedor");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Ag_Ed_Proveedor_Controlador controladorEdicion = new Ag_Ed_Proveedor_Controlador(this.vistaEdicion, model, this.controller);
        vistaEdicion.setTitle("Modificar Proveedor");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaAdminProveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaAdminProveedor().setVisible(true);
            }
        });
    }
    ...
    public void update(java.util.Observable updatedModel, Object parametros) {
        ...
        this.jTable_usuarios.setModel(model.obtener_modelo_proveedor());
        this.revalidate();
    }
